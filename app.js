...
let DetailedRoutesUP = [
    ...
    ["5K/92R"].concat(
        getStops(SRPT_MNBD, "SECUNDERABAD", "MEHDIPATNAM"),
        getStops(SKPL_SECB, "RETHIBOWLI", "DAIRY FARM - CHINTALMET"),
    ...
    ["10K/250"].concat(
        ...
        SHD[536],
        SHD[335],
        getStops(LGPL_CRPL, "HYDERABAD PUBLIC SCHOOL", "ASHOK NAGAR (NFC)"),
    ...
    ["24E"].concat(
        ...
        "DEFENCE COLLEGE", SHD[712], SHD[996], "VAYUPURI NORTH",
        getStops(GWRL_HCLX, 'SAINIKPURI X ROADS', 'ECIL X ROADS')
    ),
    ["24S"].concat(
    ...
    ["92R"].concat(
        ...
        getStops(SECB_SKPL, 'DAIRY FARM - CHINTALMET', 'RETHIBOWLI'),
        SHD[620]
    ),
    ["92R/5K"].concat(
        SHD[807],
    ...
    ["94R"].concat(
        ...
        getStops(DRFM_RMNG, 'DAIRY FARM - CHINTALMET', 'RAJENDRA NAGAR VILLAGE'),
        SHD[807]
    ),
    ["94RM"].concat(
        getStops(KSR_SHMB, 'KOTI MEDICAL COLLEGE', 'BAHUDURPURA'),
    ...
    ["188/251"].concat(
        ...
        getStops(RMNG_DRFM, 'SAI RAM NAGAR (SUNCITY)', 'DAIRY FARM - CHINTALMET'),
    ...
    ["251/188"].concat(
        ...
        getStops(DRFM_RMNG, 'DAIRY FARM - CHINTALMET', 'SAI RAM NAGAR (SUNCITY)'),
...
let DetailedRoutesDOWN = [
    ...
    ["94R"].concat(
        SHD[807],
        getStops(RMNG_DRFM, 'RAJENDRA NAGAR VILLAGE', 'DAIRY FARM - CHINTALMET'),
...
let DetailedRoutesSubStopUP = [
    ...
    ["10YF/16S"].concat(
        ...
        SHD[536],
        SHD[335],
        getSubStops(LGPL_CRPL, "HYDERABAD PUBLIC SCHOOL", "METTUGUDA"),
    ...
    ["10H/18C"].concat(
        ...
        SHD[536],
        SHD[335],
        getSubStops(LGPL_CRPL, "HYDERABAD PUBLIC SCHOOL", "PATNY"),
    ...
    ["10K/250"].concat(
        ...
        SHD[536],
        SHD[335],
        getSubStops(LGPL_CRPL, "HYDERABAD PUBLIC SCHOOL", "ASHOK NAGAR (NFC)"),
    ...
    ["92R"].concat(
        ...
        getSubStops(SECB_SKPL, 'DAIRY FARM - CHINTALMET', 'RETHIBOWLI'),
        SHD[620]
    ),
    ...
    ["94R"].concat(
        ...
        getSubStops(DRFM_RMNG, 'DAIRY FARM - CHINTALMET', 'RAJENDRA NAGAR VILLAGE'),
        SHD[807]
    ),
    ["94RM"].concat(
        getSubStops(KSR_SHMB, 'KOTI MEDICAL COLLEGE', 'BAHUDURPURA'),
    ...
    ["188/251"].concat(
        ...
        getSubStops(RMNG_DRFM, 'SAI RAM NAGAR (SUNCITY)', 'DAIRY FARM - CHINTALMET'),
    ...
    ["224G/10KM"].concat(
        ...
        SHD[536],
        SHD[335],
        getSubStops(LGPL_CRPL, "HYDERABAD PUBLIC SCHOOL", "SECUNDERABAD")
    ),
    ["224G/219"].concat(
    ...
    ["251/188"].concat(
        ...
        getSubStops(DRFM_RMNG, 'DAIRY FARM - CHINTALMET', 'SAI RAM NAGAR (SUNCITY)'),
...
let DetailedRoutesSubStopDOWN = [
    ...
    ["45F"].concat(
        ...
        SHD[536],
        SHD[335],
        getSubStops(LGPL_CRPL, "HYDERABAD PUBLIC SCHOOL", "PARADISE"),
    ...
    ["92R"].concat(
        SHD[620],
        getSubStops(SKPL_SECB, 'RETHIBOWLI', 'DAIRY FARM - CHINTALMET'),
    ...
    ["94R"].concat(
        SHD[807],
        getSubStops(RMNG_DRFM, 'RAJENDRA NAGAR VILLAGE', 'DAIRY FARM - CHINTALMET'),
